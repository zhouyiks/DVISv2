    ...
    def forward(self, frame_embeds_no_norm, frame_reid_embeds, mask_features, targets, frames_info, matcher, resume=False, using_thr=False):
        ...
        for i in range(T):
            ...
            if i == 0 and resume is False:
                ...
                output_1 = self.noiser(single_frame_embeds_no_norm, single_frame_embeds_no_norm, activate=False)
                ...
                output_1 = self.noiser(self.track_queries, single_frame_embeds_no_norm, activate=True)  # TODO matching by reid_embeds
    ...
    def inference(self, frame_embeds_no_norm, frame_reid_embeds, mask_features, frames_info, start_frame_id, resume=False, to_store="cpu"):
        ...
        for i in range(T):
            ...
            if i == 0 and resume is False:
                ...
                reference = self.reid_embed(self.track_queries)
                output_1 = self.noiser(self.track_queries, single_frame_embeds_no_norm, activate=False)
                output_2 = self.track_queries
                for j in range(3):
                    output_1 = self.transformer_cross_attention_layers_denoise[j](
                        indentify=output_1, tgt=reference,
